...
CREATE TABLE `benefit_type` (
  `id` int(11) NOT NULL,
  `benefitType` varchar(500) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `benefit_type` (`id`, `benefitType`, `status`) VALUES
(1, 'Festival Bonus', 1),
(2, 'Others', 1);
...
INSERT INTO `department` (`id`, `branch`, `dept_name`, `status`) VALUES
(2, 'Dhaka', 'Management', 1),
(3, 'gazipur', 'Accounts', 1),
(4, 'tongi', 'Marketing', 1);
...
INSERT INTO `edu_type` (`id`, `eduType`, `status`) VALUES
(1, 'Masters/MBA/MSC', 1),
(2, 'Honors/BBA/BSC', 1),
(3, 'SSC', 1),
(4, 'HSC', 1);
...
CREATE TABLE `empcat` (
  `id` int(11) NOT NULL,
  `empCat` varchar(500) NOT NULL,
  `grp` varchar(100) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `empcat`
--

INSERT INTO `empcat` (`id`, `empCat`, `grp`, `status`) VALUES
(1, 'Mangement', 'A', 1),
(2, 'Accounts', 'B', 1);
...
INSERT INTO `emp_type` (`id`, `empType`, `status`) VALUES
(1, 'Permanent', 1),
(4, 'Daily Worker', 1);
...
--
-- Table structure for table `holidaytype`
--

CREATE TABLE `holidaytype` (
  `id` int(11) NOT NULL,
  `holyType` varchar(500) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `holidaytype`
--

INSERT INTO `holidaytype` (`id`, `holyType`, `status`) VALUES
(1, 'hygf', 1),
(3, 'stg', 1);
...
CREATE TABLE `leavetype` (
  `id` int(11) NOT NULL,
  `leaveType` varchar(600) NOT NULL,
...
INSERT INTO `leavetype` (`id`, `leaveType`, `days`, `status`) VALUES
(1, 'Casual Leave', '10', 1),
(2, 'Medical Leave', '15', 1),
(4, 'Earn Leave', '12', 1),
(5, 'Maternity Leave', '90', 1);
...
--
-- Table structure for table `salarymatrix`
--

CREATE TABLE `salarymatrix` (
  `id` int(11) NOT NULL,
  `basic` varchar(200) NOT NULL,
  `HomeRent` varchar(200) NOT NULL,
  `MedAllowance` varchar(200) NOT NULL,
  `FoodAllowance` varchar(200) NOT NULL,
  `conveyance` varchar(200) NOT NULL,
  `ProbFund` varchar(200) NOT NULL,
  `status` int(11) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `salarymatrix`
--

INSERT INTO `salarymatrix` (`id`, `basic`, `HomeRent`, `MedAllowance`, `FoodAllowance`, `conveyance`, `ProbFund`, `status`) VALUES
(1, '50', '20', '5', '5', '10', '10', 1);
...
INSERT INTO `section` (`id`, `branch`, `dept`, `sec_name`, `status`) VALUES
(1, 'tongi', 'Management', 'Sec-1', 1);
...
CREATE TABLE `tbl_shift` (
  ...
  `lateAllowed` varchar(200) NOT NULL,
  `absentAllowed` varchar(200) NOT NULL,
  `weekend1` varchar(200) NOT NULL,
  `weekend2` varchar(200) NOT NULL,
...
INSERT INTO `tbl_shift` (`id`, `shiftName`, `startTime`, `endTime`, `lateAllowed`, `absentAllowed`, `weekend1`, `weekend2`, `shiftType`, `status`) VALUES
(1, 'Day', '5 : 55 PM', '5 : 55 PM', '5 : 55 PM', '5 : 55 PM', 'None', 'None', 'Day', 1);
...
--
-- Indexes for table `holidaytype`
--
ALTER TABLE `holidaytype`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `salarymatrix`
--
ALTER TABLE `salarymatrix`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `empcat`
--
ALTER TABLE `empcat`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
-- AUTO_INCREMENT for table `holidaytype`
--
ALTER TABLE `holidaytype`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `salarymatrix`
--
ALTER TABLE `salarymatrix`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
